        ...
        <nav id="sidebar" class="sidebar-wrapper" style="z-index: 9999">
            ...
            <div class="sidebar-footer">
                <div class="mx-auto btn-group dropup text-primary">
                    <a class="nav-link dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="mx-auto btn-group dropup text-primary">
                    <a class="nav-link dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="badge badge-pill badge-primary notification">15</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <div class="mx-auto btn-group dropup text-danger">
                    <a class="nav-link dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                            <a class="dropdown-item" id="cerrar-sesion">
